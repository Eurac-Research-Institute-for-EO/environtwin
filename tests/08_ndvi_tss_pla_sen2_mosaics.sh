...
INPUT_DIRS=(
	#"/mnt/CEPH_PROJECTS/Environtwin/FORCE/level3/indices/mosaic/01/X0006_Y0000_X0006_Y0001/mosaic"
...
INPUT_SEN2=(
	#"/mnt/CEPH_PROJECTS/Environtwin/FORCE/level3/indices/SEN2/mosaic/X0008_Y0000_X0008_Y-001/mosaic"
	#"/mnt/CEPH_PROJECTS/Environtwin/FORCE/level3/indices/SEN2/mosaic/X0006_Y0000_X0006_Y0001/mosaic"
	"/mnt/CEPH_PROJECTS/Environtwin/FORCE/level3/indices/SEN2/mosaic/X0007_Y0000_X0007_Y-001/mosaic"
)

BASE_OUTPUT="/mnt/CEPH_PROJECTS/Environtwin/FORCE/level3/indices/mosaic/02"
...
for i in "${!INPUT_DIRS[@]}"; do
    ...
    FILES_ALL=($(find "$INPUT_DIR" "$SEN2_DIR" -maxdepth 1 -type f \
        \( -name "*_PLANET_masked_blue_NDV.vrt" -o -name "*_SEN2*.vrt" \)))
    ...
    \( -name "${year}*_PLANET_masked_blue_NDV.vrt" -o -name "${year}*_SEN2*.vrt" \) \
    | awk -F'/' '{
        fname=$NF;
