...
# Define your UDM2 band names (adjust if needed)
band_names = ["clear", "snow", "shadow", "haze_light", "haze_heavy", "cloud", "confidence", "udm2"]
...
def find_rasters(root_folder):
    ...
    for root, dirs, files in os.walk(root_folder):
        for filename in files:
            if filename.endswith("_PLANET_udm2_mask.tif"):  # ✅ updated to correct format
