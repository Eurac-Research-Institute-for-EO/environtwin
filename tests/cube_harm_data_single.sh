...
OUTPUT_DIR="/mnt/CEPH_PROJECTS/Environtwin/FORCE/level2_small"
...
for YEAR in "${YEARS[@]}"; do
    ...
    for ZIP_FILE in "$YEAR_DIR"/batch_*.zip; do
        ...
        TIFF_FILES=$(find "$EXTRACT_DIR/files" -type f -name '*20240304*_AnalyticMS_SR_8b_harmonized_clip.tif')
