...
level3_root="/mnt/CEPH_PROJECTS/Environtwin/FORCE/level3_sites/indices/SEN2"
out_base="/mnt/CEPH_PROJECTS/Environtwin/FORCE/level3_sites/indices/SEN2/mosaic"
