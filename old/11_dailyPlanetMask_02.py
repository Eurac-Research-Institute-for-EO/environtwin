...
udm_folder = '/mnt/CEPH_PROJECTS/Environtwin/FORCE/level2_sites_raw/MH/standard'
...
def find_pairs():
    ...
    # Scan UDM files
    udm_pattern = os.path.join(udm_folder, "*_PLANET_udm2_buffer.tif")
...
def process_date_subfolder(args):
    ...
    out_dir = os.path.join(output_root, "MH")
